        ...
        <>
            ...
            >
                <div className='flex items-center pb-30'>
                    <div className='text-2xl font-semibold tracking-tight text-black'>CodeStack</div>
                ...
                {menuItems.map(({ href, name }) => (
                    <Link
                        onClick={onClose}
                        className={classNames('block lg:inline-block !text-black text-lg mb-10 hover:!text-blue-500')}
                        key={`${href}-${name}`}
                        href={href}
                    >
                        {name}
